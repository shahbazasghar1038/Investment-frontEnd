...
const Packages = () => {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-50 dark:text-white">Designed for business teams like yours</h2>
          <p className="mb-5 font-light text-gray-100 sm:text-xl  ">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
      <div className="space-y-8 lg:grid lg:grid-cols-4 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div className="flex flex-col text-gray-100 p-6 mx-auto max-w-lg text-center   bg-[#5546d1] rounded-lg   shadow  ">
              ...
              <p className="font-light text-gray-100  first-line:sm:text-lg ">Relevant for multiple users, extended & premium support.</p>
              <div className="flex justify-center items-baseline my-8">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-100 bg-[#5546d1] rounded-lg   shadow  ">
              ...
              <p className="font-light  text-gray-100 sm:text-lg  ">Best for large scale uses and extended redistribution rights.</p>
              <div className="flex justify-center items-baseline my-8">
