...
import shape1 from '../../img/shapes/hero-shape-1.svg'
import shape2 from '../../img/shapes/hero-shape-2.svg'
const SignUp = () => {
  return (
    <div>
      <section class="e ca ci di">
        <div class="a">
          <div class="ja qb _d">
            <div class="jc ng">
              <div class="wow fadeInUp la cd pe re gf kf mg yk gl vm" data-wow-delay="0s">
                <h3 class="va fi mi pi yi vl gn">
                  Create your account
                </h3>
                <p class="lb fi ii qi xi ul">
                  It's totally free and super easy
                </p>
                <button class="br cr ta qb jc be de oe re af if kf lg ii qi xi kk el ql ul em">
                  <span class="wa">
                ...
                <div class="xa qb be de">
                  <span class="sb ic jc pd pf bg nm"></span>
                  <p class="jc _g fi ii qi xi ul">
                ...
                <form>
                  <div class="xa">
                    <label for="name" class="va ob hi qi aj vl">
                      Full Name
                    </label>
                    <input type="text" name="name" placeholder="Enter your full name" class="br cr jc oe re af if zg sg ii _i ej lj pk rk el ql" />
                  </div>
                  <div class="xa">
                    <label for="email" class="va ob hi qi aj vl">
                      Work Email
                    </label>
                    <input type="email" name="email" placeholder="Enter your Email" class="br cr jc oe re af if zg sg ii _i ej lj pk rk el ql" />
                  </div>
                  <div class="xa">
                    <label for="password" class="va ob hi qi aj vl">
                      Your Password
                    </label>
                    <input type="password" name="password" placeholder="Enter your Password" class="br cr jc oe re af if zg sg ii _i ej lj pk rk el ql" />
                  </div>
                  <div class="xa qb">
                    <label for="checkboxLabel" class="qb vd xd hi qi xi ul">
                      <div class="e">
                        <input type="checkbox" id="checkboxLabel" class="b" />
                        <div class="box oa mb qb gc vc be de ne re af jf zk cl">
                          <span class="fj">
                      ...
                      <span>
                        ...
                        <a href="javascript:void(0)" class="bj mk">
                  ...
                  <div class="ta">
                    <button class="zq qb jc be de oe of rg jh ii qi zi rj sj tj jk">
                      Sign up
                    </button>
                  </div>
                </form>
                <p class="fi ii qi xi ul">
                  Already using Startup?
                  <a href="signin.html" class="bj mk">
                    Sign in
                  </a>
                </p>
              </div>
        ...
        "></div> */}
        <img src={shape1} alt class="d l f ea" />
        <img src={shape2} alt class="d m f ea" />
      </section>
    </div>
  )
}
